...
const loadCMS=()=>{
  if(document.querySelector('script[data-z33-cms]'))return;
  const s=document.createElement('script');s.src='/enhancements5.js?v=20260826-gallery';s.defer=true;s.dataset.z33Cms='1';document.body.appendChild(s);
};
const fix=()=>{
