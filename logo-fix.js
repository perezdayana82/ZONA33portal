...
const fix=()=>{fixLogo();fixSite();document.querySelectorAll('a.brand').forEach(a=>a.href=LANDING);load('/enhancements5.js?v=20260827-cms4','data-z33-cms');load('/enhancements6.js?v=20260827-cal5','data-z33-calendar');load('/enhancements9.js?v=20260827-admin9','data-z33-admin');load('/instagram-fix.js?v=20260827-ig-url1','data-z33-ig-url')};
